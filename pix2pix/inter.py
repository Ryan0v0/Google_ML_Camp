...
parser.add_argument('--model_dir', dest='model_dir', default="/Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/exp1/experiment_0/",
                    help='directory that saves the model checkpoints')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=16, help='number of examples in batch')
parser.add_argument('--text', type=str, default="谷歌", help='the source images for inference')
...
parser.add_argument('--save_dir', default='/Users/zhaowanru/class/google/ICalligraph/ICalligraph/static/images/', type=str, help='path to save inferred images')
...
parser.add_argument('--src_font', dest='src_font', default='/Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/data/raw_fonts/SimSun.ttf', help='path of the source font')
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = UNet(batch_size=args.batch_size, input_width=args.canvas_size, output_width=args.canvas_size,
                     experiment_id=args.experiment_id, embedding_dim=args.embedding_dim, embedding_num=185)
        ...
        for _, images in batch_iter:
            ...
            if len(batch_buffer) == 10:
                save_imgs(batch_buffer, count, args.save_dir,args.text)
                batch_buffer = list()
            count += 1
