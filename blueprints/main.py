...
from ICalligraph.decorators import confirm_required, permission_required
from ICalligraph.extensions import db
from ICalligraph.forms.main import DescriptionForm, TagForm, CommentForm
from ICalligraph.models import User, Photo, Tag, Follow, Collect, Comment, Notification
from ICalligraph.notifications import push_comment_notification, push_collect_notification
from ICalligraph.utils import rename_image, resize_image, redirect_back, flash_errors
...
@main_bp.route('/produce', methods=['GET','POST'])
@login_required
def produce():
    if request.method == 'POST':
        inputm = request.form.get('a', 0)
    else:
        inputm = u"请输入中文"
    typeface = request.form.get('b','wrong')

    print(typeface)
    if typeface == "wxz":
        print("python3 /Users/zhaowanru/class/google/ICalligraph/ICalligraph/cycleGAN/test.py --text=" + inputm)
        os.system("python3 /Users/zhaowanru/class/google/ICalligraph/ICalligraph/cycleGAN/test.py --text=" + inputm)
    elif typeface == "zzy":

        os.system("python3 /Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/inter.py \
                            --model_dir=/Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/exp2/experiment_0 \
                            --text=" + inputm)

    elif typeface == "zwr":
        '''
        #os.system("python3 /Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/inter.py \
                                    --model_dir=/Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/exp3/experiment_0 \
                                    --text=" + inputm)
        '''
    elif typeface == "yxr":
        '''
        #os.system("python3 /Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/inter.py \
                                    --model_dir=/Users/zhaowanru/class/google/ICalligraph/ICalligraph/gan/exp4/experiment_0 \
                                    --text=" + inputm)
        '''
    else:
        typeface_addr = 'awsl'

    #print("addr="+typeface_addr)
    return render_template('main/produce.html', inputtext=inputm)
