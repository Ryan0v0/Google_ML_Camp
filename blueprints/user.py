...
from ICalligraph.emails import send_change_email_email
from ICalligraph.extensions import db, avatars
from ICalligraph.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from ICalligraph.models import User, Photo, Collect
from ICalligraph.notifications import push_follow_notification
from ICalligraph.settings import Operations
from ICalligraph.utils import generate_token, validate_token, redirect_back, flash_errors
